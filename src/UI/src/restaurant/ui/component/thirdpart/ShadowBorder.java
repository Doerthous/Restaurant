package restaurant.ui.component.thirdpart;
...
public class ShadowBorder implements Border {
    ...
    public static class Builder {
        ...
        public ShadowBorder buildSpecial(Insets insets){
            ShadowBorder sb = new ShadowBorder(size, color, alpha,
                    paddingLeft, paddingTop);
            sb.insetsActual = insets;
            return sb;
        }
    }
    ...
    private Insets insetsMax, insetsActual;

...
public class ClientService implements IClientService{
    ...
    public ClientService(String tableId){
        this.tableId = tableId;
        peer = new Peer(tableId);
        peer.start();
        chat = new Chat(peer);
        peer.sendCommand(IPeer.BROADCAST_ID, ModuleCommand.CLIENT_TO_KITCHEN_WHO_IS_KITCHEN, null);
    }
    @Override
    public String getTableId(){ return tableId; }
    @Override
    public List<IDishInfo> getDishMenu(){
    ...
    public void sendOrder(Map<String, Integer> order){
        peer.sendCommand("kitchen", ModuleCommand.CLIENT_TO_KITCHEN_NEW_ORDER, order);
    }
    @Override
